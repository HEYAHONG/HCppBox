...
add_custom_target(${EXECUABLE_NAME}.ihx ALL
                  COMMAND ${SDCC_PATH}/sdcc -m${SDCC_PORT} --std-${SDCC_MCS51_STD} --model-${SDCC_MCS51_MODEL} --iram-size ${SDCC_MCS51_IRAM_SIZE} --xram-size ${SDCC_MCS51_XRAM_SIZE} --code-size ${SDCC_MCS51_CODE_SIZE} -o ${CMAKE_BINARY_DIR}/${EXECUABLE_NAME}.ihx ${MAIN_SOURCE} ${ARGN}
                  SOURCES ${MAIN_SOURCE}
