...
#define HRSA3072_PLAIN_MESSAGE_PADDING_BYTES        (11)                        /**< 为保证明文< 系数n,填充至少为1 */

#define HRSA3072_PLAIN_MESSAGE_BYTES                (HRSA3072_CIPHER_MESSAGE_BYTES-HRSA3072_PLAIN_MESSAGE_PADDING_BYTES)

typedef uint8_t hrsa3072_plain_message_t[HRSA3072_PLAIN_MESSAGE_BYTES];        /**< 明文 */
 ...
 * \param plain_message const hrsa3072_plain_message_t 明文
 ...
 *
 * \param ctx hrsa3072_context_t* 上下文
 * \param plain_message hrsa3072_plain_message_t 明文
