/***************************************************************
 * Name:      huint1920.h
 * Purpose:   声明huint1920接口
 * Author:    HYH (hyhsystem.cn)
 * Created:   2025-04-23
 * Copyright: HYH (hyhsystem.cn)
 * License:   MIT
 **************************************************************/
#ifndef __HUINT1920_H__
#define __HUINT1920_H__
#include "stdint.h"
#include "stdbool.h"
#include "stdlib.h"
#ifdef __cplusplus
...
#define HUINT1920_BITS_COUNT 1920

typedef struct huint1920 huint1920_t;
struct huint1920
{
    uint32_t val[(HUINT1920_BITS_COUNT/(sizeof(uint32_t)*8))+((HUINT1920_BITS_COUNT%(sizeof(uint32_t)*8))!=0?1:0)];
};


/** \brief 从字节中加载大数
 *
 * \param num huint1920_t* 大数指针
...
/** \brief 复制
 *
 * \param dst huint1920_t* 目标大数
 * \param src const huint1920_t* 源大数
 *
 */
 ...
 *
 * \param dst huint1920_t* 目标大数
 * \param src1 const huint1920_t* 源大数1
 * \param src2 const huint1920_t* 源大数2
 *
 */
...
/** \brief 减
 *
 * \param dst huint1920_t* 目标大数,dst=src1-src2
 * \param src1 const huint1920_t* 源大数1
 * \param src2 const huint1920_t* 源大数2
 *
 */
...
typedef struct huint1920_state huint1920_state_t;
struct huint1920_state
{
    huint1920_t state[8];        /**< 固定采用8个寄存器 */
};

/** \brief 乘
 *
 * \param state huint1920_t* 状态值，用于中间状态存储,不可为空
 * \param dst huint1920_t* 目标大数,dst=src1*src2
 * \param src1 const huint1920_t* 源大数1
 * \param src2 const huint1920_t* 源大数2
 *
...
/** \brief 乘(外部分配的状态寄存器)
 *
 * \param state huint1920_state_t * 状态值，用于中间状态存储,不可为空
 * \param dst huint1920_t* 目标大数,dst=src1*src2
 * \param src1 const huint1920_t* 源大数1
 * \param src2 const huint1920_t* 源大数2
 *
...
/** \brief 除
 *
 * \param state huint1920_t* 状态值，存储余数。state=src1%src2
 * \param state1 huint1920_t* 状态值，用于中间状态存储,不可为空
 * \param state2 huint1920_t* 状态值，用于中间状态存储,不可为空
 * \param dst huint1920_t* 目标大数,dst=src1/src2
 * \param src1 const huint1920_t* 源大数1
 * \param src2 const huint1920_t* 源大数2
 *
...
/** \brief 除(采用栈作为临时变量存储)
 *
 * \param mod huint1920_t* 状态值，存储余数。mod=src1%src2
 * \param dst huint1920_t* 目标大数,dst=src1/src2
 * \param src1 const huint1920_t* 源大数1
 * \param src2 const huint1920_t* 源大数2
 *
 ...
 * \param state1 huint1920_t* 状态值，用于中间状态存储,不可为空
 * \param state2 huint1920_t* 状态值，用于中间状态存储,不可为空
 * \param dst huint1920_t* 目标大数,dst=src1的src2次方
 * \param src1 const huint1920_t* 源大数1
 * \param src2 const huint1920_t* 源大数2
 *
 */
 ...
 * \param state1 huint1920_t* 状态值，用于中间状态存储,不可为空
 * \param state2 huint1920_t* 状态值，用于中间状态存储,不可为空
 * \param state3 huint1920_t* 状态值，用于中间状态存储,不可为空
 * \param dst huint1920_t* 目标大数,dst=src1的src2次方对src3取模
 * \param src1 const huint1920_t* 源大数1
 * \param src2 const huint1920_t* 源大数2
 * \param src3 const huint1920_t* 源大数3
 *
 */
