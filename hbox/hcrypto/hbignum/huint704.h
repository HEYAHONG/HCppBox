/***************************************************************
 * Name:      huint704.h
 * Purpose:   声明huint704接口
 * Author:    HYH (hyhsystem.cn)
 * Created:   2025-04-23
 * Copyright: HYH (hyhsystem.cn)
 * License:   MIT
 **************************************************************/
#ifndef __HUINT704_H__
#define __HUINT704_H__
#include "stdint.h"
#include "stdbool.h"
#include "stdlib.h"
#ifdef __cplusplus
...
#define HUINT704_BITS_COUNT 704

typedef struct huint704 huint704_t;
struct huint704
{
    uint32_t val[(HUINT704_BITS_COUNT/(sizeof(uint32_t)*8))+((HUINT704_BITS_COUNT%(sizeof(uint32_t)*8))!=0?1:0)];
};


/** \brief 从字节中加载大数
 *
 * \param num huint704_t* 大数指针
 ...
 * \param src const huint704_t* 源大数
 *
 */
...
/** \brief 除
 *
 * \param state huint704_t* 状态值，存储余数。state=src1%src2
 * \param state1 huint704_t* 状态值，用于中间状态存储,不可为空
 * \param state2 huint704_t* 状态值，用于中间状态存储,不可为空
 * \param dst huint704_t* 目标大数,dst=src1/src2
 * \param src1 const huint704_t* 源大数1
 * \param src2 const huint704_t* 源大数2
 *
 ...
 * \param state1 huint704_t* 状态值，用于中间状态存储,不可为空
 * \param state2 huint704_t* 状态值，用于中间状态存储,不可为空
 * \param state3 huint704_t* 状态值，用于中间状态存储,不可为空
