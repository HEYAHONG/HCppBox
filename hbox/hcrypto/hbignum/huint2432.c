...
void huint2432_load(huint2432_t *num,const uint8_t *bytes,size_t bytes_count)
{
...
void huint2432_load_be(huint2432_t *num,const uint8_t *bytes,size_t bytes_count)
{
    if(num==NULL || bytes==NULL)
    {
        return;
    ...
    {
        //丢弃高位
        size_t bytes_overflow=bytes_count-sizeof(huint2432_t);
...
void huint2432_load_uint32(huint2432_t *num,uint32_t uint32_num)
{
    if(num==NULL)
    {
        return;
...
void huint2432_load_uint64(huint2432_t *num,uint64_t uint64_num)
{
    if(num==NULL)
    {
        return;
...
void huint2432_store(huint2432_t *num,uint8_t *bytes,size_t bytes_count)
{
    if(num==NULL || bytes==NULL)
    {
        return;
...
void huint2432_store_be(huint2432_t *num,uint8_t *bytes,size_t bytes_count)
{
    if(num==NULL || bytes==NULL)
    {
        return;
...
void huint2432_store_uint32(const huint2432_t *num,uint32_t* uint32_num)
{
...
void huint2432_store_uint64(const huint2432_t *num,uint64_t* uint64_num)
{
...
void huint2432_copy(huint2432_t *dst,const huint2432_t *src)
{
...
void huint2432_bitwise_not(huint2432_t *dst,const huint2432_t *src)
{
    if(dst==NULL || src==NULL)
    {
        return;
...
void huint2432_bitwise_and(huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
...
void huint2432_bitwise_or(huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
    if(dst==NULL || src1==NULL || src2==NULL)
    {
        return;
...
void huint2432_bitwise_xor(huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
    if(dst==NULL || src1==NULL || src2==NULL)
    {
        return;
...
int huint2432_compare(const huint2432_t *src1,const huint2432_t *src2)
{
...
void huint2432_complement(huint2432_t *dst,const huint2432_t *src)
{
    if(dst==NULL || src==NULL)
    {
        return;
...
static size_t huint2432_left_shift_internal(huint2432_t *dst,const huint2432_t *src,size_t bits)
{
    if(dst==NULL || src==NULL)
    {
        return 0;
...
void huint2432_left_shift(huint2432_t *dst,const huint2432_t *src,size_t bits)
{
    if(dst==NULL || src==NULL)
    {
        return;
    ...
    huint2432_copy(dst,src);

    while(bits > 0)
    {
        bits-=huint2432_left_shift_internal(dst,dst,bits);
    }
}

static size_t huint2432_right_shift_internal(huint2432_t *dst,const huint2432_t *src,size_t bits)
{
    if(dst==NULL || src==NULL)
    {
        return 0;
...
void huint2432_right_shift(huint2432_t *dst,const huint2432_t *src,size_t bits)
{
    if(dst==NULL || src==NULL)
    {
        return;
    ...
    while(bits > 0)
    {
        bits-=huint2432_right_shift_internal(dst,dst,bits);
    }
}

void huint2432_bit_set(huint2432_t *dst,size_t bits)
{
    if(dst!=NULL)
    {
        if(bits >= HUINT2432_BITS_COUNT)
...
void huint2432_bit_clear(huint2432_t *dst,size_t bits)
{
    if(dst!=NULL)
    {
        if(bits >= HUINT2432_BITS_COUNT)
...
bool huint2432_bit(const huint2432_t *dst,size_t bits)
{
    if(dst!=NULL)
    {
        if(bits >= HUINT2432_BITS_COUNT)
...
size_t huint2432_clz(const huint2432_t *dst)
{
    if(dst!=NULL)
    {
        ...
        for(size_t i=index_start; i < HUINT2432_BITS_COUNT; i++)
        {
            if(huint2432_bit(dst,HUINT2432_BITS_COUNT-1-i))
            {
                return i;
            }
        }
    ...
    return HUINT2432_BITS_COUNT;
}

size_t huint2432_ctz(const huint2432_t *dst)
{
    if(dst!=NULL)
    {
        size_t index_start=0;
...
bool huint2432_t_is_zero(const huint2432_t * src)
{
    bool ret=false;
    if(src==NULL)
    {
...
bool huint2432_t_is_one(const huint2432_t * src)
{
    bool ret=false;
    if(src==NULL)
    {
...
void huint2432_add(huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
    if(dst==NULL || src1==NULL || src2 == NULL)
    {
        return;
...
void huint2432_sub(huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
    if(dst==NULL || src1==NULL || src2 == NULL)
    {
        return;
    ...
    //求补码
    huint2432_complement(dst,src2);

    //对补码进行加
    huint2432_add(dst,dst,src1);
}

void huint2432_mul(huint2432_t *state,huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
...
void huint2432_div(huint2432_t *state,huint2432_t *state1,huint2432_t *state2,huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
    ...
    if(huint2432_compare(src2,src1) > 0)
    {
        //除数大于被除数
        huint2432_copy(state,src1);
        huint2432_load_uint32(dst,0);
        return;
    }

    size_t clz1=huint2432_clz(src1);
    size_t clz2=huint2432_clz(src2);
    if(clz1 > clz2)
    {
        //除数大于被除数
        huint2432_copy(state,src1);
    ...
    huint2432_copy(state,src1);
    size_t last_index=0;
    huint2432_left_shift(state1,src2,(clz2-clz1)-last_index);
    for(size_t i=0; i<= clz2-clz1; i++)
    {
        huint2432_right_shift_internal(state1,state1,i-last_index);
        last_index=i;
        if(huint2432_compare(state,state1) >= 0)
        {
            //被除数大于左移后的除数，直接相减并将相应位置1
            {
                //求补码
                huint2432_complement(state2,state1);
                //对补码进行加
                huint2432_add(state,state,state2);
            }
            huint2432_bit_set(dst,(clz2-clz1)-i);
        }
    }

}

void huint2432_div_with_stack(huint2432_t *mod,huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
    huint2432_t state[3]= {0};
    huint2432_div(&state[0],&state[1],&state[2],dst,src1,src2);
    if(mod!=NULL)
    {
        huint2432_copy(mod,&state[0]);
    }
}
...
void huint2432_power(huint2432_t *state,huint2432_t *state1,huint2432_t *state2,huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
    ...
    huint2432_load_uint32(state,0);
    huint2432_load_uint32(dst,1);
    if(huint2432_compare(src1,state)==0 )
    {
        //底数为0
        huint2432_load_uint32(dst,0);
        return;
    ...
    size_t clz2=huint2432_clz(src2);
    huint2432_copy(state,src1);
    for(size_t i=0; i<(HUINT2432_BITS_COUNT - clz2); i++)
    {
        if(huint2432_bit(src2,i))
        {
            //,结果应当乘上当前state的值(将幂函数的指数按照2进制进行拆分成乘法表达式)
            huint2432_mul(state1,state2,dst,state);
            huint2432_copy(dst,state2);
        }
        //计算state的平方（state的平方相当于state的指数乘2，正好对应src2下一个二进制位）
        huint2432_mul(state1,state2,state,state);
        huint2432_copy(state,state2);
    }

}

void huint2432_power_with_stack(huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2)
{
    huint2432_t state[3]= {0};
...
void huint2432_root(huint2432_t *state,huint2432_t *state1,huint2432_t *state2,huint2432_t *state3,huint2432_t *state4,huint2432_t *dst,const huint2432_t *src,size_t index)
{
    ...
    huint2432_load_uint32(dst,0);
    huint2432_load_uint64(state4,index);

    size_t dst_max_bit=(HUINT2432_BITS_COUNT-huint2432_clz(src)+index-1)/index;

    if(dst_max_bit*index > HUINT2432_BITS_COUNT)
    {
        dst_max_bit--;
    }
    ...
    {
        huint2432_bit_set(dst,dst_max_bit-i);
        huint2432_power(state,state1,state2,state3,dst,state4);
        int compare_ret=huint2432_compare(state3,src);
        if(compare_ret == 0)
        {
            break;
        }
        if(compare_ret > 0)
        {
            huint2432_bit_clear(dst,dst_max_bit-i);
        }
    }

}

void huint2432_root_with_stack(huint2432_t *dst,const huint2432_t *src,size_t index)
{
    huint2432_t state[5];
    huint2432_root(&state[0],&state[1],&state[2],&state[3],&state[4],dst,src,index);
}

void huint2432_root_with_external_state(huint2432_state_t * state,huint2432_t *dst,const huint2432_t *src,size_t index)
{
    if(state==NULL)
    {
        return;
    }
    huint2432_root(&state->state[0],&state->state[1],&state->state[2],&state->state[3],&state->state[4],dst,src,index);
}
...
void huint2432_power_mod(huint2432_t *state,huint2432_t *state1,huint2432_t *state2,huint2432_t *state3,huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2,const huint2432_t *src3)
{
    ...
    for(size_t i=0; i<(HUINT2432_BITS_COUNT - clz2); i++)
    {
        if(huint2432_bit(src2,i))
        {
            ...
            huint2432_div(dst,state1,state2,state3,dst,src3);
        }
        //计算state的平方（state的平方相当于state的指数乘2，正好对应src2下一个二进制位）
        huint2432_mul(state1,state2,state,state);
        huint2432_copy(state,state2);
        ...
        huint2432_div(state,state1,state2,state3,state,src3);
    }

}

void huint2432_power_mod_with_stack(huint2432_t *dst,const huint2432_t *src1,const huint2432_t *src2,const huint2432_t *src3)
{
...
size_t huint2432_dec_number_count(huint2432_state_t * state,const huint2432_t *src)
{
    ...
    while(!is_ok)
    {
         ...
         */
        huint2432_load_uint32(&state->state[6],10);
        huint2432_load_uint32(&state->state[7],dec_number_count);
        /*
         * 寄存器5存储10的指数的结果
         */
        huint2432_power_with_external_state(state,&state->state[5],&state->state[6],&state->state[7]);

        /*
         * 比较大小
         */
        switch(huint2432_compare(&state->state[5],src))
        {
        case 1:
        {
            is_ok=true;
...
size_t huint2432_dec_number(huint2432_state_t * state,const huint2432_t *src,size_t index)
{
    size_t dec_number=0;
    if(state==NULL || src==NULL)
    {
     ...
     */
    huint2432_load_uint32(&state->state[6],10);
    huint2432_load_uint32(&state->state[7],index+1);
    /*
     * 寄存器5存储10的指数的结果
     */
    huint2432_power_with_external_state(state,&state->state[5],&state->state[6],&state->state[7]);
     ...
     * 第一次除法
     */
    huint2432_copy(&state->state[7],&state->state[5]);
    huint2432_div_with_external_state(state,&state->state[4],&state->state[5],src,&state->state[7]);

    /*
     * 寄存器6存储10，寄存器7存储10的指数
     */
    huint2432_load_uint32(&state->state[7],index);
    huint2432_power_with_external_state(state,&state->state[5],&state->state[6],&state->state[7]);

    /*
     * 第二次除法
     */
    huint2432_copy(&state->state[6],&state->state[4]);
    huint2432_copy(&state->state[7],&state->state[5]);
    huint2432_div_with_external_state(state,&state->state[4],&state->state[5],&state->state[6],&state->state[7]);

    uint32_t result=0;
    huint2432_store_uint32(&state->state[5],&result);
    dec_number=result;
