...
static const hruntime_symbol_t hruntime_libc_symbol[]=
{
    ...
    {hdefaults_str(close),(uintptr_t)&close},
    {hdefaults_str(environ),(uintptr_t)&environ},
    ...
    {hdefaults_str(ioctl),(uintptr_t)&ioctl},
    {hdefaults_str(lseek),(uintptr_t)&lseek},
    ...
    {hdefaults_str(nanosleep),(uintptr_t)&nanosleep},
    {hdefaults_str(open),(uintptr_t)&open},
    {hdefaults_str(openat),(uintptr_t)&openat},
    {hdefaults_str(putchar),(uintptr_t)&putchar},
    {hdefaults_str(puts),(uintptr_t)&puts},
    {hdefaults_str(setenv),(uintptr_t)&setenv},
    {hdefaults_str(snprintf),(uintptr_t)&snprintf},
    {hdefaults_str(sprintf),(uintptr_t)&sprintf},
    {hdefaults_str(stderr),(uintptr_t)&stderr},
    {hdefaults_str(stdin),(uintptr_t)&stdin},
    {hdefaults_str(stdout),(uintptr_t)&stdout},
    ...
    {hdefaults_str(unsetenv),(uintptr_t)&unsetenv},
    {hdefaults_str(vfprintf),(uintptr_t)&vfprintf},
    {hdefaults_str(vsnprintf),(uintptr_t)&vsnprintf},
    {hdefaults_str(wcslen),(uintptr_t)&wcslen},
    {hdefaults_str(wcsncmp),(uintptr_t)&wcsncmp},
    {hdefaults_str(write),(uintptr_t)&write},
};
